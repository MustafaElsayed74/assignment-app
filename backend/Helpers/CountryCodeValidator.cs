...
/// <summary>
/// Utility class to validate ISO 3166-1 alpha-2 country codes.
/// </summary>
public static class CountryCodeValidator
{
    // A HashSet of all valid ISO 3166-1 alpha-2 country codes.
    // In a real production app, this might be loaded from a configuration file or database,
    // but a static HashSet is very fast and meets the requirements.
